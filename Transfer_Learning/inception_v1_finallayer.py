...
tf.app.flags.DEFINE_string(
    'train_data', '/home/prakash/kaggle-fish/fish/data/*',
...
tf.app.flags.DEFINE_string(
'features_db', "features.hdf5",
"the name of features file which will save the data")

tf.app.flags.DEFINE_integer("approx_images", 3700, "The Approximate number of Images in the data")
