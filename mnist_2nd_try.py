...
with mnist_graph.as_default():
    ...
    test_pyx1 = tf.nn.softmax(model(test_data,w1,w2,w3,w4,w5,w6,w7,b1,b2,b3,b4,b5,b6,b7),name="test_set") # No need to keep the probabilities here. We will use the entire network.
...
with tf.Session(graph=mnist_graph) as sess:
	...
	for i in range(n_iterations):
		...
		if i%10 ==0:
			saver.save(sess,"/tmp/model.mnist3")
			print("Model is saved in file: %s")
